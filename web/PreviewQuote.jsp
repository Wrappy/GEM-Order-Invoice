<%-- 
    ...
    Created on : Nov 14, 2014, 3:09:53 PM
    Author     : Gord
--%>
...
%>
    ...
    <body>
        ...
        <center><h1>Quotation/Estimate</h1></center>
        <table width="100%">
            <tr>
                <td width ="75%">
                    <%
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td width="50%" align="right">
                                <b>
                                    <%
                                        //get quote date, estimate number, and customer code
                                        String sDate = getField("quotes","quoteDate","quoteID",request.getParameter("Quote"));
        ...
        <table width="100%">
            ...
            <%
                ...
                try
                {
                    ...
                    con = DriverManager.getConnection("jdbc:mysql://localhost:3306/4fd3","root","");
                    Statement st = con.createStatement();
                    String sql = "SELECT * FROM quoteinfo WHERE quote='"+request.getParameter("Quote")+"'";
                    ResultSet rs = st.executeQuery(sql);
                    int recCount = 0;
                    while(rs.next())
                    {
