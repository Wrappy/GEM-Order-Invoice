    ...
    <div class="mainContent">
      <div class="productRow"><!-- Each row contains info of 3 elements -->
        <div class="productInfo"><!-- Each individual menu item -->
          ...
          <input type="button" name="button" value="Client Screen" class="buyButton" onclick="window.open('client_screen.html','_blank'); return false;">
        </div>
        <div class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="images/quote.png"></div>
          <p class="price">&nbsp;</p>
          <p class="productContent">&nbsp;</p>
          <input type="button" name="button" value="Quote Screen" class="buyButton" onclick="window.open('quote_screen.html','_blank'); return false;">
        </div>
        <div class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="images/invoice.png"></div>
          <p class="price">&nbsp;</p>
          <p class="productContent">&nbsp;</p>
          <input type="button" name="button" value="Invoice Screen" class="buyButton" onclick="window.open('invoice_screen.html','_blank'); return false;">
        </div>
      </div>
    </div>
  </div>
