      		...
      		<!-- The quote description information is contained here -->
        		...
        		<table border="0" width="100%">
        			...
        			<tbody>
        				<tr>
        					<th><b>1</b></th>
        					<td><input type="text" name="data[0][qCode]" style="width:99%;" value="SNPP01_01_01"></input></td>
        					<td><input type="text" name="data[0][qDesc]" style="width:99%;" value="On Site Work"></input></td>
        					<td><input type="text" name="data[0][qQty]" style="width:99%;text-align:right;" value="6"></input></td>
        					<td><input type="text" name="data[0][qPrice]" style="width:99%;text-align:right;" value="10.50"></input></td>
        					<td><input type="text" name="data[0][qUnit]" style="width:99%;" value="hr"></input></td>
        					<td><input type="text" name="data[0][qAmount]" style="width:99%;text-align:right;" value=""></input></td>
        					<td style="text-align:right;"><label style="width:99%;text-align:right;">63.00</label></td>
        				</tr>
        				<tr>
        					<th><b>2</b></th>
        					<td><input type="text" name="data[0][qCode]" style="width:99%;" value="SNPP01_01_02"></input></td>
        					<td><input type="text" name="data[0][qDesc]" style="width:99%;" value="Servers"></input></td>
        					<td><input type="text" name="data[0][qQty]" style="width:99%;text-align:right;" value="2"></input></td>
        					<td><input type="text" name="data[0][qPrice]" style="width:99%;text-align:right;" value=""></input></td>
        					<td><input type="text" name="data[0][qUnit]" style="width:99%;" value=""></input></td>
        					<td><input type="text" name="data[0][qAmount]" style="width:99%;text-align:right;" value="200.00"></input></td>
        					<td style="text-align:right;"><label style="width:99%;text-align:right;">400.00</label></td>
        				</tr>
        				<tr>
        					<th><b>3</b></th>
        					<td><input type="text" name="data[0][qCode]" style="width:99%;"></input></td>
        					<td><input type="text" name="data[0][qDesc]" style="width:99%;"></input></td>
        					<td><input type="text" name="data[0][qQty]" style="width:99%;text-align:right;"></input></td>
        					<td><input type="text" name="data[0][qPrice]" style="width:99%;text-align:right;"></input></td>
        					<td><input type="text" name="data[0][qUnit]" style="width:99%;"></input></td>
        					<td><input type="text" name="data[0][qAmount]" style="width:99%;text-align:right;"></input></td>
        					<td style="text-align:right;"><label style="width:99%;text-align:right;"></label></td>
        				</tr>
        				<tr>
						    <td colspan="9"><button type="button">&lt;</button><button type="button">&gt;</button><button type="button">New Quote</button><button type="button">Commit</button></td>
        				</tr>
        			</tbody>
        		</table>
      		</section>
    ...
    ****************************************************************************-->
      	...
      	<nav>
        	<ul>
          		...
          		<li><a href="invoice_screen.html" title="Link">Invoice Screen</a></li>
        	</ul>
      	</nav>
   	</aside>
    <footer>
